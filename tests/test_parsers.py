...
def test_reaction_parser_no_asterisk_coefficients():
    ...
    experimental_output_digit_in_end_of_met_id = ([('glc', 1.0, None)], [('co2', 1.0, None)], False)
    ...
    assert reaction_parser(reaction_string_digit_in_end_of_met_id) == experimental_output_digit_in_end_of_met_id, "Reaction parser does not work with digits in the end of metabolite IDs"
